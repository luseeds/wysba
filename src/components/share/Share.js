...
const Share = () => (
  <Section title="Share" reverse className="result-share">
    ...
    <div className="fb-share-button" data-href="http://wysba.luseeds.com" data-layout="button" data-size="large" data-mobile-iframe="true"><a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwysba.luseeds.com%2F&amp;src=sdkpreparse" className="fb-xfbml-parse-ignore">Share</a></div>
